...
## RUN PAUSED then RESUMED — 2026-07-10. User /usage ground truth: 51% total / 51% fable (orchestrator estimate was ~35pts too pessimistic; real calibration ≈0.76M tokens/1%). ~29pts headroom to the 80% caps → crush M1-M3 resumed from stash.
